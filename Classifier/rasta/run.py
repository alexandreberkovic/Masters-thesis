...
parser.add_argument('--train_path', action="store", default=join(PATH, '/home/ec2-user/SageMaker/wikiart_binary/train'),dest='training_path',help='Path of the training data directory')
parser.add_argument('--val_path', action="store", default=join(PATH, '/home/ec2-user/SageMaker/wikiart_binary/test'),dest='test_path',help='Path of the test data directory')
